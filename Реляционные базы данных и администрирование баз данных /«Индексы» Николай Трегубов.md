...
Основная проблемы возникет при сортировке данных по customer_id и f.title, а также при применении оконной агрегации и временных таблиц.
```sql
...
```
Для оптимизации запроса был внесен индекс на столбец payment_date в таблице payment, это дало буст в производительности запроса.  
Теперь запрос работает быстрее и оптимизированно.
